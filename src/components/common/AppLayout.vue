...
const mobileNavItems = navItems.filter((item) => item.to !== '/about' && item.to !== '/map' && item.to !== '/settings')
const moreItems = navItems.filter((item) => item.to === '/map' || item.to === '/settings' || item.to === '/about')
